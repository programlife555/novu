...
export const NavOrganizationSelectRenderer: React.FC<INavOrganizationSelectRendererProps> = ({
...
export const NavOrganizationSelect = () => {
  return <NavOrganizationSelectRenderer {...useOrganizationSelect()} />;
};
